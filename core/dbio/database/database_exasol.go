...
// GenerateIncrementalSQL generates the upsert SQL for Exasol
func (conn *ExasolConn) GenerateIncrementalSQL(srcTable string, tgtTable string, pkFields []string) (sql string, err error) {
