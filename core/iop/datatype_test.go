...
// go test -benchmem -run='^$ github.com/slingdata-io/sling/core/iop' -bench '^BenchmarkParseString'
...
// go test -benchmem -run='^$ github.com/slingdata-io/sling/core/iop' -bench '^BenchmarkProcessRow'
...
// go test -benchmem -run='^$ github.com/slingdata-io/sling/core/iop' -bench '^BenchmarkCastToString'
...
func TestExcel(t *testing.T) {
	...
	assert.NoError(t, err)
	localFs.SetProp("SLING_COMPRESSION", "NONE")
