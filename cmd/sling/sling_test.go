...
`
...

	{
		...
		assert.Equal(t, sling.UpdateKey{"col3"}, config.Source.UpdateKey)
...

	{
		...
		assert.Equal(t, sling.UpdateKey{"col2"}, config.Source.UpdateKey)
		assert.Equal(t, "|", config.Source.Options.Delimiter)
...

	{
		...
		assert.Equal(t, sling.UpdateKey{}, config.Source.UpdateKey)
